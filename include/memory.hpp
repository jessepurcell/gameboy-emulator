 ...
 *
 * This class provides methods to read and write bytes and words to the Game
 * Boy's memory.
 */
class Memory {
 public:
  ...
  /**
   * @brief Returns the memory array.
   *
   * @return The memory array.
   */
  const std::array<uint8_t, 0x10000>& getMemory() const { return memory; }
